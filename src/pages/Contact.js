          ...
          <div>
            ...
            <div className="mt-2.5">
              <input
                ...
                className="block w-full rounded-md bg-white px-3.5 py-2 text-base text-gray-800 transition-colors duration-300 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-blue-500"
              />
            </div>
          </div>
          <div>
          ...
          <div className="sm:col-span-2">
            ...
            <div className="mt-2.5">
              <input
                ...
                type="email"
                autoComplete="email"
                className="block w-full rounded-md bg-white px-3.5 py-2 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-blue-500"
              />
            </div>
          </div>
          <div className="sm:col-span-2">
            ...
            <div className="mt-2.5">
              <div className="flex rounded-md bg-white outline outline-1 -outline-offset-1 outline-gray-300 has-[input:focus-within]:outline has-[input:focus-within]:outline-2 has-[input:focus-within]:-outline-offset-2 has-[input:focus-within]:outline-blue-500">
        ...
        <label htmlFor="spam" className="hidden text-sm/6 font-semibold text-gray-800 dark:text-gray-200 transition-colors duration-300">
            ...
            <div className="mt-2.5">
              <input
                ...
                type="spam"
                autoComplete="email"
                className="w-full hidden rounded-md bg-white px-3.5 py-2 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2"
              />
            </div>
